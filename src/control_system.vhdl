...
architecture Behavioral of control_subsystem is
...
begin
    ...
    acq_phase_inc_count_reg <= acq_phase_inc_count_reg;
        ...
        if(reset = '1') then
            ...
            if(spi_write_op_strobe = '1') then
                ...
                if(to_integer(signed(spi_op_addr)) = COMMAND_ADDR)then
                    ...
                    acq_sv_test_taps <= spi_write_op_data(GPS_GOLD_TAPS_WIDTH-1 downto 0);
                    ...
                    acq_phase_inc_start_reg <= spi_write_op_data(PHASE_COUNT_WIDTH-1 downto 0);
                end if;
            elsif(spi_read_op_req = '1') then
            end if;
        end if;
    end process;
